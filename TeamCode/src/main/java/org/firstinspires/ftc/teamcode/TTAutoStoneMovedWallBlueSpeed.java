        ...
        while (opModeIsActive()) {
          ...
          switch (currentState) {
            ...
            case MOVEBASEPLATE:
              ...
              robot.fastLeftDrive(45);
              robot.fastSyncTurn(173, 4);
              robot.timeDrive(0.5, 0.6, 0);
            ...
            case GOTOBLOCK6:
              ...
              robot.fastRearDrive(5);
              robot.fastSyncTurn(0, 1);
              currentState = AutoState.GRABBLOCK2;
              break;
            case GRABBLOCK2:
              robot.fastRearDrive(87);
              robot.setClawPosition(ClawPosition.Close);
              sleep(500);
              robot.lift.LiftBrickWait(0);
