...
//Pusheddown
                ...
                double angle = controller.readStick();
                Direction L = controller.readLStick();
                Direction R = controller.readRStick();
                if (L.x > 0.01 || L.x < -0.01 || L.y > 0.01 || L.y < 0.01 || -0.01 < R.x  || R.x > 0.01) {
